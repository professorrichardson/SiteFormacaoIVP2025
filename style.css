...
header {
  ...
  justify-content: center;    /* Espaço entre elementos */
...
.link{
  margin-bottom: 15px;              /* Espaço entre parágrafos e links */
  color: #040404;                      /* Cor do texto secundário */
}
...
body.dark-mode .link {
  margin-bottom: 15px;              /* Espaço entre parágrafos e links */
  color: #ede8e8;                      /* Cor do texto secundário */
}
